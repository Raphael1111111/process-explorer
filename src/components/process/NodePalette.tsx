...
import { NODE_TYPE_STYLE, type NodeType } from "@/types/process";
      ...
      {ORDER.map((type) => {
        ...
        return (
          <button
            ...
            title={t("palette.button.title", { label })}
          >
            <span
              className={cn(
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[12px] font-medium leading-none text-foreground">{label}</p>
